...
@app.route("/Resources/vtuber hood on/vtuber hood on.1024/texture_00.png", methods = ["GET"])
def resourcesPNG():
    return send_file("Resources/vtuber hood on/vtuber hood on.2048/texture_00.png", mimetype= "image/png")


def deleteAudio(path):
    sleep(1)
    os.remove(os.path.join(os.getcwd(), 'RRcodeNew', 'audioResult', path +'.wav'))
